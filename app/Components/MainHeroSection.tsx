...
function MainHeroSection() {
  ...
  const noAnim: Variants = { hidden: {}, show: {} };
  ...
  return (
    <motion.div
      ...
      variants={isDesktopScreen ? container : noAnim}
      ...
      <div className="w-full h-full pyramid-design-container relative z-20">
        <div className="w-full flex items-stretch justify-start">
          <motion.div className="w-[70%]" variants={isDesktopScreen ? fadeRight : noAnim}>
            <div className="w-full h-full flex flex-col justify-end items-start gap-20 xl:gap-[100px]">
              <motion.div className="w-full" variants={isDesktopScreen ? fadeUp : noAnim}>
              ...
              <motion.div className="w-full relative" variants={isDesktopScreen ? fadeUp : noAnim}>
                <Image
                ...
                <motion.div
                  ...
                  variants={isDesktopScreen ? fadeLeft : noAnim}>
              ...
              <div className="w-full h-full flex flex-col items-start justify-end">
                {["Architect Design", "Interior Design", "3D Modeling"].map((item, i) => (
                  <motion.h2
                    ...
                    variants={isDesktopScreen ? fadeUp : noAnim}>
