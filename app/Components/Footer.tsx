  ...
  return (
    <footer className="w-full pt-5 xl:pt-17.5">
      <div className="pyramid-design-container">
        <div className="w-full grid grid-cols-3 pb-10">
          <div className="w-full flex flex-col items-start justify-start gap-8">
            ...
            <div className="flex items-center justify-start gap-10 pt-4">
          ...
          <div className="w-full flex flex-col items-start justify-start gap-5 xl:px-30 xl:pl-40">
          ...
          <div className="w-full flex flex-col items-start justify-start gap-5 xl:px-30">
            <Link
              href="/faq"
              title="faq"
              aria-label="faq"
        ...
        <div className="border-t border-t-black/15 py-10 flex items-center justify-center">
          <Link
            href={"/"}
            title="ThinkArq Logo"
            aria-label="ThinkArq Logo"
            className="w-fit h-fit -ml-1 font-kaisei-decol text-sm text-center">
